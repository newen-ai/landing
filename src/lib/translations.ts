...
export const translations: Record<Lang, Translation> = {
  es: {
    ...
    hero: {
      eyebrow: "Consultoria y desarrollo de software · Desde Argentina y Alemania al mundo",
      title: "La fuerza estrategica detras del crecimiento de tu empresa.",
      subtitle:
        "Consultoria empresarial, desarrollo de software, ERP e integracion de inteligencia artificial. Con base en Argentina y Alemania.",
      ctaPrimary: "Agendar una consulta",
      ctaSecondary: "Ver servicios",
      whyLabel: "Por que funciona",
      whyItems: [
        "Estrategia y ejecucion alineadas a objetivos reales del negocio",
        "Implementacion rapida, sin resignar calidad ni control",
        "Metricas claras y mejora continua",
      ],
      outcomeLabel: "Enfoque en resultados",
      outcomeText: "De la estrategia a la implementacion en semanas, no trimestres.",
    },
    stats: {
      leftValue: "+15",
    ...
    services: {
      ...
      featuredText: "Arquitectura, integraciones y productos a medida. El corazon tecnico de Newen.",
      featuredLink: "Ver mas ->",
      cards: [
        { title: "Consultoria empresarial", text: "Diagnostico y mejora de procesos" },
        { title: "ERP e implementacion", text: "Odoo, Tango, Jazz, Bejerman" },
        { title: "IA y automatizacion", text: "Claude, ChatGPT, Make, n8n, agentes propios" },
        { title: "Procesos y CRM", text: "Ventas, seguimiento y gestion comercial" },
        { title: "E-commerce", text: "Tiendas online, integraciones de pago y logistica" },
        {
          title: "Growth Partner o consultoria clasica",
          text: "Pago por resultados o por proyecto, segun lo que necesites",
        },
      ],
    },
    how: {
      ...
      steps: [
        { num: "01", title: "Diagnostico", desc: "Mapeamos procesos, datos y oportunidades reales." },
        { num: "02", title: "Diseno", desc: "Arquitectura de la solucion a medida." },
        { num: "03", title: "Desarrollo", desc: "Software, ERP, IA y automatizacion en semanas." },
        { num: "04", title: "Resultados", desc: "Medimos, optimizamos y acompanamos." },
      ],
    },
    team: {
      label: "Equipo",
      ...
      members: [
        {
          ...
          bio: "Lidera la vision estrategica y las relaciones de Newen, con foco en convertir consultoria, procesos e IA en crecimiento medible para las empresas.",
        ...
        },
        {
          ...
          bio: "Impulsa la arquitectura tecnica de Newen, garantizando sistemas escalables, seguros y confiables para el desarrollo de software y la integracion de IA.",
        ...
        },
        {
          ...
          bio: "Lidera el posicionamiento de mercado y la ejecucion go-to-market, conectando las capacidades de Newen con resultados concretos para los clientes.",
    ...
    history: {
      ...
      intro:
        "Newen nace de una experiencia real construida en sectores muy distintos entre si: compliance automotriz internacional, modernizacion de gestion publica a gran escala e infraestructura blockchain de punta. Esa mezcla es la base de como trabajamos: no llegamos a un problema desde una sola disciplina, sino con la experiencia concreta de haber resuelto desafios serios en industrias que no perdonan errores.",
      cards: [
        {
          title: "Compliance automotriz internacional",
          text: "Gestion de cumplimiento normativo OBD para Volkswagen, coordinando requisitos tecnicos y regulatorios entre equipos globales.",
        },
        {
          title: "Modernizacion de gestion publica",
          text: "Mas de 80 proyectos: tramites 100% online verificados con AFIP, primera autoridad de firma digital propia y un programa de eficiencia energetica con IBM (USD 500.000).",
        },
        {
          title: "Infraestructura blockchain multichain",
          text: "Plataforma de liquid staking con integracion NEAR, Ethereum, Aurora y Solana.",
        },
        {
    ...
    contact: {
      label: "Contacto",
      title: "Charlamos sobre como hacer crecer tu empresa?",
      namePlaceholder: "Tu nombre",
      emailPlaceholder: "Tu email",
      messagePlaceholder: "Contanos en que podemos ayudarte",
      submit: "Agendar una consulta",
      divider: "o escribinos directo",
      emailButton: "Escribinos",
      whatsappButton: "WhatsApp (Proximamente)",
      whatsappSoon: "Proximamente",
